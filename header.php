...
<div id="wrapper" class="hfeed">
	...
	<div id="header">
		...
		<a id="home-link" href="http://jococruisecrazy.com/"></a>
		<div id="header-widgets" class="sidebar">
			<ul class="xoxo">
				<?php dynamic_sidebar('header') ?>
			</ul>
		</div><!-- #primary .sidebar -->
		<div id="book-now">
			<a href="/booking"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/book-now.gif" /></a>
		</div>
	</div><!--  #header -->
